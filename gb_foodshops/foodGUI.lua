...
function Menu.updateSelection()
	if IsControlJustPressed(1, Keys["DOWN"]) then --RECULER
		if(Menu.selection < Menu.buttonCount -1  )then
			Menu.selection = Menu.selection +1
		else
			Menu.selection = 0
		end
	elseif IsControlJustPressed(1, Keys["TOP"]) then --AVANCER
...
function ShopMenu()
	...
	if (vdkinventory == false) then
		...
		Menu.addTitle("MENU")
		Menu.addButton("Bouteille d'eau","buymenu",{1, 1, 200})
		Menu.addButton("Sandwich","buymenu",{2, 1, 123})
